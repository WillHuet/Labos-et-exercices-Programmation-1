...
/**
 * Cette classe contient la methode executerCourse devant etre utilisee dans 
 * le cadre du TP1 de INF1120.
 * 
 * @author Melanie Lord
 * @version H26
 */
public class TP1Utils {
   ...
   //Vous pouvez le changer temporairement pour 0 pour afficher le deroulement 
   //de la course plus rapidement
   ...
   /**
    * Concatene les entiers contenus dans liste, et retourne le resultat 
    * sous forme d'un int.
